...
namespace MarketplaceAPI.Migrations
{
    ...
    [Migration("20250508074914_chatmigr")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketplaceAPI.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MarketplaceAPI.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketplaceAPI.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("MarketplaceAPI.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("MarketplaceAPI.Models.Chat", b =>
                {
                    b.HasOne("MarketplaceAPI.Models.ApplicationUser", "UserA")
                        .WithMany()
                        .HasForeignKey("UserAId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MarketplaceAPI.Models.ApplicationUser", "UserB")
                        .WithMany()
            ...
            modelBuilder.Entity("MarketplaceAPI.Models.Message", b =>
                {
                    b.HasOne("MarketplaceAPI.Models.Chat", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MarketplaceAPI.Models.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("MarketplaceAPI.Models.Order", b =>
                {
                    b.HasOne("MarketplaceAPI.Models.ApplicationUser", "Buyer")
                        .WithMany()
            ...
            modelBuilder.Entity("MarketplaceAPI.Models.Product", b =>
                {
                    ...
                    b.HasOne("MarketplaceAPI.Models.ApplicationUser", "Seller")
                        .WithMany()
            ...
            modelBuilder.Entity("MarketplaceAPI.Models.ProductTag", b =>
                {
                    ...
                    b.HasOne("MarketplaceAPI.Models.Tag", "Tag")
                        .WithMany("ProductTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MarketplaceAPI.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
